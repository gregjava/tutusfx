...
<html>
	<head>
		<meta charset="utf-8"><title>Contact Tutusfx</title>
		...
		<link rel="canonical" href="eu/contact-us-eu/" />
	...
	<body>
		<?php include '../../assets/db/contactus.php'; ?>
		<script type="text/javascript">
		...
		<div class="container row">
		  <div class="maincolumn">
			<div class="card">
				...
				<?php if(isset($error) and !empty($error)){ echo ("<marquee><h4>".$error."</marquee></h4>"); $error ==""; unset($error); } ?>
				<form method="POST">
					<div>
						<div class="form-group">
							<div class="input-group"> <span class="input-group-addon">Post Category: </span>
								<select name="category" class="form-control" required="required">
									<option value="">Select a category that best relates to your post</option>
						...
						<div class="form-group">
							<div class="input-group"> 
								<span class="input-group-addon">Email Address: </span><input type="email" name="email" class="form-control" placeholder="Provide your email address" maxlength="70" required="required"><br />
							</div>
						</div>
						<div class="form-group">
							<div class="input-group"> 
								<span class="input-group-addon">Contact Phone Number: </span><input type="phone" name="phone" class="form-control" placeholder="Provide your contact phone number" maxlength="70"><br />
							</div>
						</div>
						<textarea name="content" placeholder="Say what's on your mind"></textarea><br />
		...
		<div class="footer">
		  <div class="upper-footer"><a href="">Sponsorship</a><a href="">Fund Safety &amp; Security</a><a href="">Sitemap</a><a href="">Networks</a><a href="">Contact Us</a></div>
		  <div class="card clearnav">
			...
			<div class="footerCard"><h6>CHOOSE LANGUAGE</h6>
				...
				<a href="../../de/contact-us-de/">TUTUSFX.COM DEUTSCHE</a><br/>
				<a href="../../it/contact-us-it/">TUTUSFX.COM ITALIANO</a><br/>
				<a href="../../fr/contact-us-fr/">TUTUSFX.COM FRANCAISE</a><br/>
				<a href="../../es/contact-us-es/">TUTUSFX.COM ESPAÑOL</a><br/>
				<a href="../../zh-tw/contact-us-zh-tw/">TUTUSFX.COM 中文</a><br/>
				<a href="../../hi-in/contact-us-hi-in/">TUTUSFX.COM HINDI</a><br/>
			</div>
